...
*/
 ...
 $search = param('search', ''); if($search) { $search = _xn_search_keyword_safe(xn_urldecode(trim($search))); $cond = array('name'=>array('LIKE'=>$search)); $pluginlist = arrlist_cond_orderby($plugins, $cond, array('pluginid'=>-1), 1, 999); } if($interface=='zerodream') { $pugin_cate_html = "
